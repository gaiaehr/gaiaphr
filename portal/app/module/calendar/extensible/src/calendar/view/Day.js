...
Ext.define('Extensible.calendar.view.Day', {
    ...
    initComponent: function() {
        ...
        var body = this.dayBody = Ext.applyIf({
    ...
    reRenderBody: function (config) {
        this.remove(this.id + '-bd', true);
        this.dayBody = Ext.apply(this.dayBody, config);
        this.add(this.dayBody);
        this.onResize();
    },
