 ...
 */
Ext.define('App.view.dashboard.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        App.view.dashboard.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        App.view.dashboard.PortalDropZone.superclass.unreg.call(this);
    }
});
