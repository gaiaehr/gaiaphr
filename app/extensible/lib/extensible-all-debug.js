...
Ext.define('Extensible.calendar.form.EventDetails', {
    ...
    recNumLabelText:w('recnumber'),
    firsNameLabelText:w('firstname'),
    middleNameLabelText:w('middlename'),
    lastNameLabelText:w('lastname'),
    emailLabelText:w('email'),
    dobLabelText:w('dob'),
    phoneLabelText: w('phone'),
    ...
    initComponent: function() {
        ...
        this.pidField = Ext.create('Ext.form.TextField', {
            fieldLabel: this.titleLabelText,
            name: Extensible.calendar.data.EventMappings.Pid.name,
            anchor: '70%',
            labelWidth: this.labelWidth,
            hidden:true
        });

        this.recNumField = Ext.widget('patientsearch',{
            itemId: this.id + '-recNum',
            name: Extensible.calendar.data.EventMappings.RecNum.name,
            fieldLabel: this.recNumLabelText,
            labelWidth: this.labelWidth,
            anchor: '70%'
        });

        this.firstNameField = Ext.widget('fieldcontainer',{
            itemId: this.id + '-name',
            labelWidth: this.labelWidth,
            fieldLabel: this.firsNameLabelText,
            anchor: '70%',
            layout:'hbox',
            items:[
                {
                    xtype: 'textfield',
                    itemId: this.id + '-fname',
                    name: Extensible.calendar.data.EventMappings.FirstName.name,
//                    fieldLabel: this.firsNameLabelText,
                    width: 150
                },{
                    xtype: 'textfield',
                    itemId: this.id + '-mname',
                    name: Extensible.calendar.data.EventMappings.MiddleName.name,
                    margin:'0 5',
//                    fieldLabel: this.middleNameLabelText,
                    width: 50
                },{
                    xtype: 'textfield',
                    itemId: this.id + '-lname',
                    name: Extensible.calendar.data.EventMappings.LastName.name,
//                    fieldLabel: this.lastNameLabelText,
                    flex: 1
                }
            ]
        ...
        this.middleNameField = Ext.widget('textfield',{
            itemId: this.id + '-mname',
            name: Extensible.calendar.data.EventMappings.MiddleName.name,
            fieldLabel: this.middleNameLabelText,
            labelWidth: this.labelWidth,
        ...
        this.lastNameField = Ext.widget('textfield',{
            itemId: this.id + '-lname',
            name: Extensible.calendar.data.EventMappings.LastName.name,
            fieldLabel: this.lastNameLabelText,
            labelWidth: this.labelWidth,
        ...
        this.emailField = Ext.widget('textfield',{
            itemId: this.id + '-email',
            name: Extensible.calendar.data.EventMappings.Email.name,
            fieldLabel: this.emailLabelText,
            labelWidth: this.labelWidth,
            anchor: '70%',
            vtype:'email'
        });

        this.dobField = Ext.widget('datefield',{
            itemId: this.id + '-dob',
            name: Extensible.calendar.data.EventMappings.DOB.name,
            fieldLabel: this.dobLabelText,
            labelWidth: this.labelWidth,
            format:'Y-m-d',
            width: 345
        });

        this.phoneField = Ext.widget('fieldcontainer',{
            layout:'hbox',
            fieldLabel: this.phoneLabelText,
            labelWidth: this.labelWidth,
            anchor: '70%',
            items:[
                {
                    xtype: 'textfield',
                    itemId: this.id + '-phone',
                    name: Extensible.calendar.data.EventMappings.Phone.name,
                    format:'Y-m-d',
                    width: 200
                },
                {
                    xtype: 'radiogroup',
                    itemId: this.id + '-phoneType',
                    margin:'0 10',
                    width: 200,
                    items: [
                        {
                            boxLabel: 'cel',
                            name: Extensible.calendar.data.EventMappings.PhoneType.name,
                            inputValue: 'cel',
                            checked: true
                        },
                        {
...
//        });
        ...
        if(this.recurrence) {
            ...
            leftFields.splice(4, 0, this.recurrenceField);
        }
        ...
        if(this.calendarStore) {
            ...
            leftFields.splice(6, 0, this.calendarField);
        }
...
Ext.define('Extensible.calendar.form.EventWindow', {
    ...
    getFooterBarConfig: function() {
        var cfg = ['->',
            {
                xtype:'checkbox',
                itemId: this.id + '-resend-notification',
                action:'resendEmail',
                boxLabel:w('resend_notification'),
                hidden:true
            },{
                text: this.saveButtonText,
                itemId: this.id + '-save-btn',
...
//                    fieldLabel: this.lastNameLabelText,
    ...
    initRefs: function() {
        ...
        this.resendCheckbox = this.down('#' + this.id + '-resend-notification');
    ...
    show: function(o, animateTarget) {
        ...
        me.resendCheckbox[o.data && o.data[EventMappings.EventId.name] ? 'show' : 'hide']();
        me.resendCheckbox.reset();
