...
Ext.define('App.view.ux.ActivityMonitor',{
		singleton:true,
		...
		ready:false,
		verbose:false,
		interval:(1000 * 60),           //.5 minute
		maxInactive:(1000 * 60 * 2),    //2 minutes
		...
		captureActivity:function(eventObj, el, eventOptions){
			if(App.app.getController('Main').logoutWarinigWindow)
				App.app.getController('Main').cancelAutoLogout();
			this.lastActive = new Date();
		},
